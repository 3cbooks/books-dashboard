...
# 已经验证过应该匹配到京东自营的关键书（书名片段）
# 任何一本退化到 POP 都是数据质量问题，要警告
EXPECTED_JD_SELF_BOOKS = [
    "我是你的遗物",      # SKU 15371686 博集天卷京东自营
    "陪安东尼度过漫长岁月",  # SKU 14671295 中南天使京东自营（预订）
    "泥潭",              # SKU 14516547 漓江出版社京东自营
    "人间小满3",         # 文通天下京东自营
    "白鹿原",            # 人民文学出版社京东自营
    "万物有光",          # 磨铁图书京东自营
    "肥志百科",          # 漫友文化京东自营
